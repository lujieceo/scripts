...
echo "# 6.58. IPRoute2-4.12.0"
tar -Jxf iproute2-4.12.0.tar.xz
cd iproute2-4.12.0
...
echo "# 6.65. Eudev-3.2.2"
tar -zxf eudev-3.2.2.tar.gz
cd eudev-3.2.2
