...
echo "# 6.58. IPRoute2-4.10.0"
tar -Jxf iproute2-4.10.0.tar.xz
cd iproute2-4.10.0
...
make -j $PARALLEL_JOBS
make DOCDIR=/usr/share/doc/iproute2-4.10.0 install
cd /sources
rm -rf iproute2-4.10.0
...
echo "# 6.65. Eudev-3.2.1"
tar -zxf eudev-3.2.1.tar.gz
cd eudev-3.2.1
